    ...
    <div class="container">
               ...
               <tbody>
                   ...
                   <tr>
                       <td class="cart_product">
                           <img src=" {{URL::to('public/uploads/product/'.$v_content->options->image)}}"  width="90" alt="" />
                       </td>
       ...
       {{ csrf_field() }}
            <div class="payment-options">
                ...
                <span>
                    <label><input  name="payment_option"  value="3 " type="checkbox"> Thanh toán the ghi nợ </label>
