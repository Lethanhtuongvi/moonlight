    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="backend/images/download.jpg">
                <span class="username">
					<?php
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{URL::to('/log_out')}}"><i class="fa fa-key"></i> Đăng xuất </a></li>
            </ul>
        </li>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">  <!-- Thêm đường dẫn của add và all trong  route vào trong hr-->
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2023 <a href="{{URL::to('/trang-chu')}}">MOONLIGHT.</a> Where beauty shines.</p>
			</div>
		  </div>
  <!-- / footer -->
</section>
